	  ...
	  <div className="w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-md rounded-full">
    	<div className="max-w-6xl mx-auto px-6 py-6 flex flex-col items-center gap-6">
				...
				<div className="flex gap-6">
					<a href="https://jcesar206.github.io/myPersonalBlog/" target="_blank" rel="noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 transition">
						<FaHome size={20}/>
					</a>
